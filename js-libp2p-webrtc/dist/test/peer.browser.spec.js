...
describe('webrtc basic', () => {
    ...
    it('should connect', async () => {
        ...
        const connection = mockConnection(mockMultiaddrConnection(pair(), dstPeerId));
...
describe('webrtc filter', () => {
    it('can filter multiaddrs to dial', async () => {
        const transport = new WebRTCTransport({
            transportManager: sinon.stub(),
            peerId: sinon.stub(),
            registrar: mockRegistrar(),
            upgrader: mockUpgrader(),
            peerStore: sinon.stub()
        }, {});
        const valid = [
...
//# sourceMappingURL=peer.browser.spec.js.map